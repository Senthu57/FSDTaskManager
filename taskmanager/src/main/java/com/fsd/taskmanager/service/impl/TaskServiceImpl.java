...
public class TaskServiceImpl implements TaskService{
	...
	public TaskVO getTask(String taskId) {
		...
		taskVO.setParentTaskId(optTask.get().getParentTask().getParentId());
		taskVO.setParentTask(optTask.get().getParentTask().getParentTask());
	...
	public void updateTask(TaskVO taskVO) {
		...
		p.setParentTask(taskVO.getParentTask());
	...
	public List<ParentTaskVO> getAllParentTasks() {
		...
		for(ParentTask parentTask: parentTasks) {
			...
			parentTaskVO.setParentTaskId(parentTask.getParentId());
			parentTaskVO.setParentTaskName(parentTask.getParentTask());
